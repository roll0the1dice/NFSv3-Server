...
public class WRITE3res {
  private final NfsStat3 status;
  private final WRITE3resok resok;     // Nullable
  private final WRITE3resfail resfail; // Nullable

  private WRITE3res(NfsStat3 status, WRITE3resok resok, WRITE3resfail resfail) {
